...
encoder_first = Dense(14, activation="relu")(encoder_first)

#decoding and output layer

decoder_first = Dense(28, activation='softmax')(encoder_first)
decoder_first = Dense(28, activation='softmax')(decoder_first)
